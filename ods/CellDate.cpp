...
namespace Ods {
    ...
    const QString CellDate::kCellTypeValue = "date";
    const QString CellDate::kCellTypeAttribute = "office:date-value";
    ...
    {
        writer->writeTextElement(CellAbstract::kTextTag, _valueDate.toString("dd/MM/yyyy"));
    }
}